...
function Book4() {
    return (
        ...
        <div className="diiR">
                    <div className="dii10">
                        <p className="pX">"It is better to fail in </p>
                        <p className="pY">originality </p>
                        <p className="pZ">than to succeed in imitation."</p>
                    </div>
                </div>
            <div className="dii00">
               <p><h3>CHAPTER 1</h3>
<p>Phoenix in July. People called it Mother Nature’s rendition of hell on earth.
...
Juggling my camera bag while I dug out my cell phone didn’t do much to endear me to my fellow passengers either.</p><p>  Since our flight out of Fairbanks, Alaska had been delayed, everyone wanted off, right now. People were pulling out bags and resetting their various electronic devices.
...
Thumbing my phone’s screen, I discovered seven missed calls and two voice mails. Nerves tightened.</p><p> 
...
Like I gave a shit right now.</p><p> 
...
The shuttle lurched to a stop at the curb in a cloud of exhaust.</p><p>  I ran, weaving my way through the blistering metal of parked cars under the relentless afternoon sun, my T-shirt sticking to my back like a leech.
...
Kelsey would head north to the cabin we inherited in Sedona from our foster parents.</p><p>  The one I called home when I bothered to stick around. A little haven of security tucked away from the world. It was listed under our foster mother’s maiden name and known only to us, which made it a perfect hideout.
...
My home came into view as I cleared the last bend.</p><p>  Kelsey’s older model Lexus sat to the side of the cabin and the tight bands across my chest began to loosen in relief.
...
The Jeep came to a skidding halt on the loose gravel.</p><p>  Scrambling out, my weak leg threatened to fold under me, the stiff muscles a reminder that six months was not long enough for my body to forget the damage dealt to it.
...
<p>
<h3>CHAPTER 2</h3></p>
<p>Shock held me motionless at actually hearing Kelsey’s warning. It meant something, but damned if I knew what. There was no ‘normal’ for reliving the past, no handy user guide.

What had changed?</p><p>
...
Maybe if I went back to my room and started over?</p><p>
...
Which meant I had one shot.</p><p> Wrapping my hand on the knob, I shoved my shoulder and weight into the door, slamming it forward.
